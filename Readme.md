...
This project presents a comprehensive analysis of retail sales across multiple stores and regions.  

The analysis delivers actionable insights into product and category performance, revenue trends, and regional sales distribution to support data-driven business decisions.
...
├── python\_scripts/  Python analysis scripts

│ └── retail.py

│

├── power\_bi\_dashboard/  Power BI files \& screenshots

│ ├── Retail\_sales.pbix

│ └── Retail\_Sales\_Dashboard.png
